...
EPISODE=80
DATA_TRAIN_BATCH_SIZE=4 # Rollout Prompt Num
N_VOTES_PER_PROMPT=64
N_SAMPLES_PER_PROMPT=32
MINI_BATCH_SIZE=1 # Actual mini batch size is MINI_BATCH_SIZE * N_SAMPLES_PER_PROMPT
MICRO_BATCH_SIZE=2

DATA_LOCAL_DIR="/export/home/skokane/research/TTRL/verl/data"
BACKBONE_PATH="/export/home/skokane/models/${BACKBONE}"

MODEL="${TASK}-${BACKBONE}"
EXPERIMENT="BASE-Len@${K}k"

WANDB_PROJECT="BASE-verl"
LOG_NAME="${DATE}-${EXPERIMENT}-${MODEL}-${ADVANTAGE}"
OUTPUT_DIR="/export/home/skokane/research/TTRL/checkpoints/${WANDB_PROJECT}/${MODEL}/${DATE}/${EXPERIMENT}-${ADVANTAGE}-${TIME_TAG}"
...
python -m verl.trainer.main_ppo \
  ...
  actor_rollout_ref.rollout.do_vote=False \
